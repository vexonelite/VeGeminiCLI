...
data class MuseumGalleryApplyScreenParameter(
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun MuseumGalleryApplyScreen(
    navController: NavHostController,
    galleryApplyQueryParameters: GalleryApplyQueryParameterDelegate = BuiltInGalleryApplyQueryParameter01(),
    screenParameter: MuseumGalleryApplyScreenParameter = MuseumGalleryApplyScreenParameter(
        fontSize = 16.sp,
        ...
        tag = "MuseumGalleryApply",
    )
) {
    Logger.getLogger("MuseumGalleryApplyScreen").log(Level.INFO, "MuseumGalleryApplyScreen - time: [${System.currentTimeMillis()}]")
    ...
    BuiltInBottomSheetListScreen01(
        inputParameters = BuiltInBottomSheetListScreenParameters01<GalleryApplyItemDelegate>(
            ...
            theBottomSheetContentBlock = {
                //MuseumGalleryApplyScreenBottomSheetContent(
            ...
            theHeaderContent = {
                val suggestionChipGroupParameter = BuiltInSuggestionChipGroup01Parameter(
                    ...
                    fontSize = screenParameter.fontSize,
                    chipColors = screenParameter.chipColors,
                    containerPaddingValues = screenParameter.containerPaddingValues,
                    containerBackground = screenParameter.containerBackground,
                )
            ...
            theTag = screenParameter.tag,
        ),
        bottomSheetScaffoldState = screenParameter.bottomSheetScaffoldState,
    )
}
...
@Preview
@Composable
fun MuseumGalleryApplyScreenBottomSheetContent(
    theParameters: GalleryApplyQueryParameterDelegate = BuiltInGalleryApplyQueryParameter01(),
) {
    Logger.getLogger("MuseumGalleryApplyScreenBottomSheetContent").log(Level.INFO, "MuseumGalleryApplyScreenBottomSheetContent - time: [${System.currentTimeMillis()}]")
...
//                .padding(horizontal = 20.dp),
        ...
        Button(
            ...
            Text(
                text = stringResource(tw.com.wtc.mis.android.compose.R.string.base_action_query),
                fontSize = 20.sp,
                color = Color.White,
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun <Parameters> rememberGalleryApplyQueryScreenParameters(
    navController: NavHostController,
...
): Parameters where Parameters : GalleryApplyQueryParameterDelegate {
    ...
    val queryGalleryApplyListResultX: FmApiResult<List<GalleryApplyItemDelegate>>? by apiViewModel.queryGalleryApplyListResultStateFlow.collectAsStateWithLifecycle()
    LaunchedEffect(queryGalleryApplyListResultX) {
        val queryGalleryApplyListResult = queryGalleryApplyListResultX ?: return@LaunchedEffect

        listDataState.value = when(queryGalleryApplyListResult) {
            is FmApiResult.Success -> {
                Logger.getLogger("rememberGalleryApplyQueryScreenParameters").log(Level.INFO, "rememberGalleryApplyQueryScreenParameters - QueryGalleryApplyListResultStateFlowCollector: [Success]")
            ...
            is FmApiResult.Error -> {
                Logger.getLogger("rememberGalleryApplyQueryScreenParameters").log(Level.SEVERE, "rememberGalleryApplyQueryScreenParameters - QueryGalleryApplyListResultStateFlowCollector： .Error]", queryGalleryApplyListResult.cause)
...
//            nameValue = pair.first
        ...
        optionValue,
        { newValue: TextFieldValue -> optionValue = newValue },
        stringResource(tw.com.wtc.mis.museum_rfid.compose_ui.R.string.prompt_option),
        // </editor-fold desc="GalleryApplyQueryParameters - option">
        ...
        // <editor-fold desc="GalleryApplyQueryParameters - theOnSearchButtonClick">
        {
            ...
            if (null == authData) {
                Logger.getLogger("rememberGalleryApplyQueryParameters").log(Level.INFO, "rememberGalleryApplyQueryParameters - onSearchButtonClick - authData is null!")
                return@parametersFactory
            }
            ...
            coroutineScope.launch {
                ...
                apiViewModel.callGalleryApplyListApi(
                    scope = apiViewModel,
                    apiDomain = uiUtility.getApiDomain(),
                    authToken = authData.authToken,
                    queryModel = uiUtility.buildGalleryApplyQueryModel(
        ...
        HolderItemClickDelegate<GalleryApplyItemDelegate> { dataObject: GalleryApplyItemDelegate, action: String, position: Int ->
            ...
            coroutineScope.launch {
                val route: String = uiUtility.navigateToGalleryApplyDetailsScreen(dataObject.theDataObject)
...
interface GalleryApplyQueryParameterDelegate : MuseumSearchItemsDelegate,
    IBuiltInBottomSheetListScreenParameters01<GalleryApplyItemDelegate>
{
    val theOptionValue: TextFieldValue
    val theOptionOnValueChange: (TextFieldValue) -> Unit
    val theOptionHint: String
}



data class BuiltInGalleryApplyQueryParameter01(
    ...
    override val theOptionValue: TextFieldValue = TextFieldValue(),
    override val theOptionOnValueChange: (TextFieldValue) -> Unit = {},
    override val theOptionHint: String = "選項",
